...
import com.example.dacn_murkoff_android.AppointmentPage.AppointmentPageInfoActivity;
import com.example.dacn_murkoff_android.BookingPage.BookingPageInfoActivity;
import com.example.dacn_murkoff_android.Model.Notification;
...
public class NotificationRecyclerView extends RecyclerView.Adapter<NotificationRecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        /*set text color*/
        int colorRead = context.getColor(R.color.textColorBlack);
