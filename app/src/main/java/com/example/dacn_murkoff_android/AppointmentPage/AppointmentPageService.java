...
import com.example.dacn_murkoff_android.Model.Queue;
...
//            System.out.println("is Notify = " + isNotify);
    ...
    public void showMessageInDevice(String text, String bigText)
    {
        ...
        com.example.dacn_murkoff_android.Helper.MyNotification notification = new com.example.dacn_murkoff_android.Helper.MyNotification(this);
